...
public:
    ...
    virtual void translate(bool glb, int &mem) { assert(false); } // translate AST of eeyoreAST into AST of tigger
...
public:
    ...
    virtual void Dump() { printTab("var " + var); }virtual void translate(bool glb, int &mem) ;
};
...
public:
    ...
    virtual void translate(bool glb, int &mem) ;
};
