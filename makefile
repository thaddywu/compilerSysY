all: compiler
compiler: sysy.yy.cpp sysy.tab.cpp defs.hpp main.cpp eeyoreAST.hpp eeyoreAST.cpp eeyoreREG.cpp tiggerAST.hpp
	g++ -w -std=c++11 -DLOCALTEST -o compiler sysy.yy.cpp sysy.tab.cpp sysyAST.cpp \
		eeyoreREG.cpp eeyoreREG.cpp defs.cpp main.cpp
